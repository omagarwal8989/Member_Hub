...
const TIER_COLORS = ["#ef4444", "#f97316", "#eab308", "#84cc16", "#06b6d4"];

// Shared dark-mode tooltip style for all Recharts <Tooltip /> instances
const tooltipStyle = {
  contentStyle: {
...
export default function Reports({ onLogout }) {
  ...
  return (
    <Layout onLogout={onLogout}>
      ...
      {/* Top stat cards */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-surface-alt p-6 rounded-xl border border-border flex items-center gap-4">
        ...
        <div className="bg-surface-alt p-6 rounded-xl border border-border flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-neutral-400">Certificates Issued</p>
            <p className="text-2xl font-bold text-white">
              {stats.totalCertificatesIssued}
            </p>
          </div>
        ...
        <div className="bg-surface-alt p-6 rounded-xl border border-border flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-neutral-400">Expiring in 30 Days</p>
            <p className="text-2xl font-bold text-white">
              {stats.expiringSoon.length}
            </p>
          </div>
            ...
            <tbody className="divide-y divide-border">
              {stats.expiringSoon.map((m) => (
                <tr key={m.id} className="hover:bg-surface-hover">
                  <td className="px-6 py-3 text-sm font-medium text-neutral-200">
                    {m.name}
                  </td>
