...
export default function ConfirmDialog({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
      <div className="bg-surface-alt border border-border rounded-2xl shadow-2xl shadow-black/50 w-full max-w-sm p-6">
        <div className="flex items-start gap-3 mb-5">
        ...
        <div className="flex justify-end gap-3">
          <button
            onClick={onCancel}
            disabled={loading}
            className="px-4 py-2 rounded-lg text-sm font-medium text-neutral-300 hover:bg-surface-hover disabled:opacity-50"
          >
            Cancel
          </button>
          <button
